...
function StatusBadge({ status }) { const info = getStatusDisplay(status); return <span className={`px-2 py-0.5 text-[9px] font-semibold rounded-full border ${info.bgClass} ${info.textClass} ${info.borderClass} whitespace-nowrap`}>{info.displayLabel}</span> }
